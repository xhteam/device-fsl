...
TARGET_BOARD_INFO_FILE := device/fsl/tdh/board-info.txt

include device/fsl/imx6/soc/imx6dq.mk
include device/fsl/tdh/build_id.mk
include device/fsl/imx6/BoardConfigCommon.mk
include device/fsl-proprietary/gpu-viv/fsl-gpu.mk
# tdh default target for EXT4
...
# Bluetooth
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/fsl/tdh/bluetooth
...
TARGET_RECOVERY_UI_LIB := librecovery_ui_tdh
