...
function usage () {
	...
	echo "   device/fsl/tdh/quick_build_kernel.sh bootimage [kernel config]     --> build boot.img"
	echo "   device/fsl/tdh/quick_build_kernel.sh recoveryimage [kernel config]  --> recovery.img"
	echo "   device/fsl/tdh/quick_build_kernel.sh menuconfig                    --> open kernel menuconfig"
#	echo "   device/fsl/tdh/quick_build_kernel.sh saveconfig                    --> make savedefconfig"
}
